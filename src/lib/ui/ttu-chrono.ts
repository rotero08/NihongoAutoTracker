  ...
  `;
    ...
    btn.addEventListener('dblclick', (e) => {
        ...
        if (ttuState.running) {
            ...
            if (currentCount !== null) stateRefs.globalSessionStartChar = currentCount - (ttuState.chars - stateRefs.globalManualCharOffset);
    ...
    btnDirect.addEventListener('click', async (e) => {
        ...
        try {
            ...
            const currentCount = helpers.extractTTUCharCount();
            stateRefs.globalSessionStartChar = currentCount !== null ? currentCount : -1;
            stateRefs.globalManualCharOffset = 0; ttuState.running = false;
